    ...
    <section className={styles.section}>
          ...
          description={
            <span>
              ...
              which allows drivers to spread the payments for a car over a long
                  period, typically two or three years <br /><br />
              However, unlike a normal personal loan, you won&apos;t be paying off
              the full value of the car and you won&apos;t necessarily own it at
              the end of the deal, unless you choose to pay the final balloon
              payment PCP is one of the more complex financial products
      ...
      <div className={styles.footer__block}>
        <div className={styles.first__footerblock}>
          <h1 className={`${styles.title__footer} ${roobertBold.className}`}>
            Don&apos;t let them get away with it
          </h1>
          <p className={styles.description_firstblock}>
